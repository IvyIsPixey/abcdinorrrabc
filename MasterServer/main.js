...
var certificate = fs.readFileSync('/etc/letsencrypt/live/' + 'ms.dinorr.fun' + '/fullchain.pem');
var privatekey = fs.readFileSync('/etc/letsencrypt/live/' + 'ms.dinorr.fun' + '/privkey.pem');
